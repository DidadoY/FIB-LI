...
atMostOnePerDay:- day(D), trip(C1-C2), findall(bdcc(B,D,C1,C2), bus(B), Lits), atMost(1, Lits), fail.
atMostOnePerDay.

atLeastXDaysPerWeek:- trip(C1-C2), frequency(C1-C2, F), findall(bdcc(B,D,C1,C2), (bus(B), day(D)), Lits), atLeast(F, Lits), fail.
atLeastXDaysPerWeek.

departs:- consecutiveDays(D1, D2), bus(B), trip(C1-C2), trip(C2-C3), C2\=C3, writeClause([-bdcc(B,D1,C1,C2), -bdcc(B,D2,C2,C3)]), fail.
departs.

canTravel:- consecutiveDays(D1, D2), bus(B), tooLongDist(C1-C2-C3), C2\=C3, writeClause([-bdcc(B,D1,C1,C2), -bdcc(B,D2,C2,C3)]), fail.
canTravel.
